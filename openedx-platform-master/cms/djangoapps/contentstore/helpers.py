...
class ImportIdGenerator(IdGenerator):
    ...
    def create_definition(self, block_type, slug=None) -> DefinitionLocator:
        ...
        # NOTE: The DefinitionLocator technically only accepts an ObjectId (or a str representing an ObjectId), but
...
def _insert_static_files_into_downstream_xblock(
    ...
    # NOTE: This code shouldn't have any special cases for specific block types like video
    # in the future.
